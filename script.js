...
let layout = d3.cluster()
    .size([2*Math.PI, size.w/2 - 100]) // angular position on circle using radians to later rotate text
    (bilinks);
console.log(layout);
...
let node = svg.append('g')
    ...
    // TRY: try to change 'end' to 'start' and observe the effects
